...
function main() {
    ...
    canvas.height = h
    draw_background()
    window.addEventListener('mousedown', mousedown) // touchstart
    window.addEventListener('mousemove', mousemove) // touchmove
    window.addEventListener('mouseup', mouseup) // touchend
